...
IF(WIN32)
ELSEIF(APPLE)
	# When cross-compiling with Zig, skip Homebrew detection
	IF(NOT CMAKE_CXX_COMPILER MATCHES "zig")
		# Use Homebrew SDL2 (native macOS build)
...
ELSE()
	# Skip sdl2-config when using Zig cross-compilation (not available and not needed)
	IF(NOT CMAKE_CXX_COMPILER MATCHES "zig")
