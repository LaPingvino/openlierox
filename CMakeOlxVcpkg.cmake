...
if(NOT WIN32)
    # libgd uses pkg-config on Unix
    find_package(PkgConfig REQUIRED)
    pkg_check_modules(GD IMPORTED_TARGET gdlib)

    find_package(FREEALUT CONFIG)
else()
    # On Windows, use CMake config
    find_package(GD CONFIG)
    find_package(FREEALUT CONFIG)
endif()
...
if(NOT DEDICATED_ONLY)
    ...
    if(GD_FOUND)
        ...
        add_definitions(-DHAVE_LIBGD)
    else()
        message(STATUS "LibGD not found - image saving features will be limited")
    endif()
endif()
